 ...
 *
 * Generated: 2026-05-30T16:49:47.051Z
 * Entity types with properties: 315
 */
...
export const UPG_PROPERTY_SCHEMA: Record<string, PropertySchema> = {
  ...
  opportunity: {
    reach: {
      type: 'assessment', scale_id: 'reach_5', description: 'How many users experience this problem',
      properties: {
        value: { type: 'number', description: 'The numeric value, used for computation.' },
        label: { type: 'string', description: 'The qualitative label (what the assessor meant).' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional).' },
    ...
    frequency: {
      type: 'assessment', scale_id: 'frequency_5', description: 'How often users experience this problem',
      properties: {
        value: { type: 'number', description: 'The numeric value, used for computation.' },
        label: { type: 'string', description: 'The qualitative label (what the assessor meant).' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional).' },
    ...
    pain: {
      type: 'assessment', scale_id: 'pain_5', description: 'How painful it is when unaddressed',
      properties: {
        value: { type: 'number', description: 'The numeric value, used for computation.' },
        label: { type: 'string', description: 'The qualitative label (what the assessor meant).' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional).' },
  ...
  solution: {
    ...
    reach: {
      type: 'assessment', scale_id: 'reach_5', description: 'How many users this solution reaches (1 = few, 5 = most)',
      properties: {
        value: { type: 'number', description: 'The numeric value, used for computation.' },
        label: { type: 'string', description: 'The qualitative label (what the assessor meant).' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional).' },
    ...
    impact: {
      type: 'assessment', scale_id: 'impact_5', description: 'Expected impact on the target outcome (1 = minimal, 5 = transformative)',
      properties: {
        value: { type: 'number', description: 'The numeric value, used for computation.' },
        label: { type: 'string', description: 'The qualitative label (what the assessor meant).' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional).' },
    ...
    confidence: {
      type: 'assessment', scale_id: 'confidence_5', description: 'How confident the team is in this solution (1 = speculative, 5 = proven)',
      properties: {
        value: { type: 'number', description: 'The numeric value, used for computation.' },
        label: { type: 'string', description: 'The qualitative label (what the assessor meant).' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional).' },
    ...
    effort: {
      type: 'assessment', scale_id: 'effort_5', description: 'Level of effort required to implement (1 = trivial, 5 = very large)',
      properties: {
        value: { type: 'number', description: 'The numeric value, used for computation.' },
        label: { type: 'string', description: 'The qualitative label (what the assessor meant).' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional).' },
