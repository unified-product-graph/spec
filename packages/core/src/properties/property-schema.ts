 ...
 *
 * Generated: 2026-06-13T10:55:29.604Z
...
export const UPG_PROPERTY_SCHEMA: Record<string, PropertySchema> = {
  ...
  competitor_signal: {
    ...
    signal_type: { type: 'string', enum: ['feature_launch', 'pricing_change', 'acquisition', 'partnership', 'market_entry'], description: 'Kind of move. `feature_launch` = shipped a feature. `pricing_change` = a plan or tier change. `acquisition` / `partnership` / `market_entry` = strategic moves.' },
