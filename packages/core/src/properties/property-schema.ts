 ...
 *
 * Generated: 2026-06-10T21:30:34.497Z
 * Entity types with properties: 318
 */
...
export const UPG_PROPERTY_SCHEMA: Record<string, PropertySchema> = {
  ...
  test_plan: {
    ...
    environments: { type: 'object', description: 'Environments the plan exercises (mirrors `TestEnvironmentProperties.env_type`).' },
