...
import type { WorkspaceProperties, FrameworkExerciseProperties, CompositionProperties, CaptureProperties } from './domains/workspace.js'
...
export interface UPGPropertyMap {
  ...
  /** A named, dated, self-nesting planning interval (sprint / iteration / quarter / PI / cooldown) work is scheduled through: the cadence axis */
  planning_cycle: PlanningCycleProperties
  configuration_axis: ConfigurationAxisProperties
  ...
  /** A dated, hashed rendition of a node already in the graph: a screenshot, an export, a PDF */
