...
> 🧪 **Early alpha.** UPG v0.25.0. The format, ontology, and APIs are still evolving and breaking changes can land between versions. Pin a version if you need stability. Issues and feedback are welcome.
